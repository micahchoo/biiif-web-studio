...
function decompress(dataView, compressionMethod, returnType = "string") {
...
function readCompressedIcc(dataView, iccData) {
  ...
  return decompress(compressedDataView, iccData[0].compressionMethod, "dataview").then(parseTags2).catch(() => ({}));
}
