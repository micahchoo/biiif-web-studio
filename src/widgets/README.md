...
import { AnnotationControls } from '@/src/features/whiteboard/ui/organisms';
import { MetadataQuickEdit } from '@/src/features/metadata-edit/ui/organisms';
...
export const AnnotationToolbar: React.FC<AnnotationToolbarProps> = ({
  ...
  <div className="flex gap-2">
    ...
    <MetadataQuickEdit cx={cx} fieldMode={fieldMode} />
  </div>
);
```
